  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-between">
        ...
        <div>
          <a v-if="isAuth" href="/cart" class="nav-item">
            <img class="cart-icon" src="/public/img/cart.png" alt="Cart">
          </a>
          <a v-if="isAuth" href="/history" class="nav-item">
            <img class="cart-icon" src="/public/img/list.png" alt="History">
          </a>
          <a v-if="isAuth" href="/logout" class="btn btn-danger">Выход</a>
          <a v-if="!isAuth" href="/login" class="btn btn-success">Вход</a>
        </div>
      </div>
    </div>
  </nav>
